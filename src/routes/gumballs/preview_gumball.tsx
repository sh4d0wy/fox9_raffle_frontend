...
function PreviewGumballs() {
  ...
  return (
      <main className='bg-black-1400'>
        <div className="w-full pb-2  md:pt-48 pt-36 md:py-10 max-w-[1440px] md:px-5 px-4 mx-auto">
            <button onClick={() => router.history.go(-1)}  className="bg-gray-1000 cursor-pointer mb-10 rounded-[80px] w-fit inline-flex h-10 md:h-[49px] justify-center items-center pl-5 pr-3.5 md:px-6 gap-2 md:gap-2.5  md:text-base text-sm font-semibold text-white font-inter">
            ...
            <div className="w-full max-w-[1440px] md:px-5 px-4 mx-auto">
                        ...
                        <div className="w-full">
                            ...
                            <div className="w-full">
                                ...
                                <div className="w-full">
                                    ...
                                    <PrimaryButton onclick={()=>setTokenModel(true)} text='Manage Gumball' className='w-full bg-primary-color/25! border-transparent text-white h-12' />
                                    </div>
                                    }
                ...
                <div className="w-full">
                        <div className="md:grid md:grid-cols-2 items-start gap-5 pt-10">
                            <div className="w-full">
                            <h2 className='text-xl pb-8 text-white font-bold font-inter'>Gumball Prizes</h2>
                            <GumballPrizesTable/>
                            </div>
                            <div className="flex-1">
                            <h2 className='text-xl pb-8 text-white font-bold font-inter'>Last Spins</h2>
                            <LastSpinsTable/>
                            </div>
                      </div>
                 </div>
