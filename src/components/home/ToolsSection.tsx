...
export const ToolsSection = () => {
  return (
    <section className="w-full">
      ...
      <div className="absolute -bottom-[100%] lg:block 5xl:hidden hidden z-0 left-0">
        <svg xmlns="http://www.w3.org/2000/svg" width="100%" height="1284" viewBox="0 0 1365 1784" fill="none">
